...
public class BRADLEYMOBIJ48 {
	public static final int iterasyonSayisi=25;
	public static void main(String[] args) throws Exception {
		...
		System.out.println("wal Data size -> "+walData.size());
		System.out.println("std Data size -> "+stdData.size());
		System.out.println("jog Data size -> "+jogData.size());
		System.out.println("jum Data size -> "+jumData.size());
		System.out.println("stu Data size -> "+stuData.size());
		System.out.println("stn Data size -> "+stnData.size());
		System.out.println("sch Data size -> "+schData.size());
		System.out.println("csi Data size -> "+csiData.size());
		System.out.println("cso Data size -> "+csoData.size());
...
//			System.out.println("cso_cluster_Threshold -> "+cso_cluster_threshold);
		...
		for(int tt=0;tt<secmedenAgacSayisi.size();tt++) {
			System.out.println((secerekAgacSayisi.get(tt)-secmedenAgacSayisi.get(tt))/secmedenAgacSayisi.get(tt)*100);
		}
		System.out.println("Seçerek Artan Başarı");
		for(int tt=0;tt<basarilar.size();tt++) {
			System.out.println(basarilar.get(tt)-basarilar2.get(tt));
		}
